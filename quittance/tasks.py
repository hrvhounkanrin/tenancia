...
def get_contrat_en_cours():
    ...
    for contrat in contrats:
        ...
        quittance = Quittance(
            ...
            date_emission=datetime.today(),
            date_valeur=date_valeur,
            debut_periode=sart_of_month,
            fin_periode=end_of_month,
            nature="QUITTANCE DE LOYER",
            contrat=contrat,
            montant=contrat.montant_bail,
        )
        prochaine_echeance = date(
            sart_of_month.year, sart_of_month.month, contrat.jour_emission
