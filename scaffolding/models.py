...
class Immeuble(models.Model):
    ...
    created_by = models.ForeignKey(
        ...
        null=True,
        editable=False,
        related_name="simmeuble_created_user",
    )
    modified_by = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        null=True,
        editable=False,
        related_name="simmeuble_updated_user",
    )
...
class Appartement(models.Model):
    ...
    immeuble = models.ForeignKey(
        "scaffolding.Immeuble", null=True, on_delete=models.SET_NULL
    )
    structure = models.ManyToManyField(
        TypeDependence,
        through="StructureAppartement",
        blank=False,
        related_name="scaffolding_structure",
    )
    ...
    created_by = models.ForeignKey(
        ...
        null=True,
        editable=False,
        related_name="sappartement_created_user",
    )
    modified_by = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        null=True,
        editable=False,
        related_name="sappartement_updated_user",
    )
...
class StructureAppartement(models.Model):
    ...
    appartement = models.ForeignKey(
        "Appartement",
        related_name="scaffolding_appartement",
