...
from mauth.config.mauth_config import MAUTH_REST_FRAMEWORK
REST_FRAMEWORK = MAUTH_REST_FRAMEWORK

from mauth.config.mauth_config import MAUTH_JWT_AUTH
JWT_AUTH = MAUTH_JWT_AUTH
